...
const groceryList = ["Apples", "Banana"];
...
function deleteItem() {
    ...
    const lastItem = groceryList[lastIndex];
    groceryList.length = lastIndex;
    return lastItem;
}
...
function displayItems() {
    ...
    for (let i = 0; i < groceryList.length; i++) {
        let formattedItem = (i + 1) + '. ' + groceryList[i];
        
        itemsWithNumbers[itemsWithNumbers.length] = formattedItem;
    }
...
let isItemFound = searchItem("Apples");
